...
nnoremap du :call vimspector#StepOut()
nnoremap di :call vimspector#StepInto()
nnoremap do :call vimspector#StepOver() 
nnoremap dr :call vimspector#Restart()
nnoremap dc :call vimspector#Continue()
nnoremap db :call vimspector#ToggleBreakpoint()
nnoremap dx :call vimspector#Reset()
nnoremap ds :call DebugProj()
...
nnoremap od :DiffVifm()
nnoremap ov :VsplitVifm()
nnoremap os :SplitVifm()
nnoremap on :TabVifm()
nnoremap oo :EditVifm()
nnoremap rm :Unite mapping
nnoremap rr :call BuildProj()
nnoremap tl :tablast
...
set runtimepath+=~/.vim/bundle/bluewery.vim
...
set runtimepath+=~/.vim/bundle/bluewery.vim/after
...
silent only
silent tabonly
cd ~/Library/Mobile\ Documents/com~apple~CloudDocs/Files/Development/learning-rust/interprocess-test
...
badd +1 client/src/main.rs
badd +1 daemon/src/main.rs
badd +1 daemon/Cargo.toml
badd +1 client/Cargo.toml
argglobal
%argdel
$argadd client/src/main.rs
set stal=2
tabnew +setlocal\ bufhidden=wipe
tabnew +setlocal\ bufhidden=wipe
tabnew +setlocal\ bufhidden=wipe
tabrewind
edit daemon/src/main.rs
argglobal
balt client/src/main.rs
let s:cpo_save=&cpo
set cpo&vim
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 10 - ((3 * winheight(0) + 16) / 32)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 10
